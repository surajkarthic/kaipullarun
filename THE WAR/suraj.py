...
pygame.mixer.music.load('kk.mid')

# set up images
playerImage1 = pygame.image.load('vadivelu.png')
playerImage = pygame.transform.scale(playerImage1, (70,70))
playerRect = playerImage.get_rect()
alienImage = pygame.image.load('karadi.png')
alien1Image = pygame.image.load('villain2.png')
superAlienImage = pygame.image.load('villan.png')
lifeImage = pygame.image.load('life.png')
powerUpImage = pygame.image.load('boost.png')
superBulletImage = pygame.image.load('hammer.png')
